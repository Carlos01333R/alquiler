        ...
        <div className="p-6 border-b">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600 flex items-center gap-2 text-sm font-medium transition-colors"
            >
                    ...
                    <tr key={doc.id} className={`hover:bg-gray-50 transition-colors ${sel ? 'bg-red-50' : ''}`}>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-3">
                          <button onClick={() => router.push(`/dashboard/cotizaciones/${doc.id}/totales`)} className="text-yellow-600 hover:text-yellow-800 text-sm font-medium">Ver</button>
                          <button
