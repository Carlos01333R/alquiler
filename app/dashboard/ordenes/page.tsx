          ...
          <div className="px-6 py-3 bg-red-50 border-b border-red-100 flex items-center justify-between">
            ...
            {!confirmarEliminar ? (
              <button onClick={() => setConfirmarEliminar(true)} className="flex items-center gap-1.5 px-4 py-2 bg-red-600 text-white rounded-md text-sm font-medium hover:bg-red-700">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round"  stroke='#fff' strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                </svg>
              ...
              <div className="flex items-center gap-2">
                <p className="text-sm text-red-700 font-medium">¿Confirmar?</p>
                <button onClick={handleEliminar} disabled={eliminando} className="px-3 py-1.5 bg-red-600  rounded text-sm disabled:opacity-60">
                 <p className='text-white'>{eliminando ? 'Eliminando...' : 'Sí, eliminar'}</p> 
                </button>
